...
class Algo12:
    """
    Uses VWAP to determine sudden changes in trend for buy/sell signals for all products except PEARLS
    """
    def __init__(self):
        ...
        self.banana_min_num_of_data = [13, 13]
        ...
        for product, order_depth in state.order_depths.items():
            ...
            if product == "PEARLS":
                ...
                if product == "COCONUTS":
                    ...
                    min_num_of_data = self.banana_min_num_of_data
                else:
